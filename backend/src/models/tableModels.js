    ...
    RETURN jsonb_build_object(
        ...
        'teachers', (
            SELECT COALESCE(
                jsonb_agg(
                    jsonb_build_object(
                        ...
                        'designation', CASE
                            WHEN dh.teacher_id IS NOT NULL THEN 'Department Head'
                            ELSE t.appointment::TEXT
                        END
                    )
                    ORDER BY
                        CASE
                            WHEN dh.teacher_id IS NOT NULL THEN 1
                            WHEN t.appointment::TEXT = 'Department Head' THEN 1
            ...
            LEFT JOIN department_heads dh
                   ON dh.department_id = v_department.id
